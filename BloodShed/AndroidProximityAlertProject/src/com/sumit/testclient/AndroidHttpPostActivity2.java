...
public class AndroidHttpPostActivity2 extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		try {
			...
			Toast.makeText(AndroidHttpPostActivity2.this, "Finished",
					Toast.LENGTH_LONG).show();

		} catch (ClientProtocolException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
			Toast.makeText(AndroidHttpPostActivity2.this, e.toString(),
					Toast.LENGTH_LONG).show();
		} catch (IOException e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
